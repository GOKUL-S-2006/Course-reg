...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    {
        // Ensure $login_username is coming from the form (POST request)
        ...
        if ($stmt->num_rows > 0) 
        {
            ...
            {
                echo "<script>alert('Invalid password.'); window.location.href = 'login_model.html';</script>";
            }
        } else {
            echo "<script>alert('NOO USER NAME FOUND .'); window.location.href = 'login_model.html';</script>";
        }
